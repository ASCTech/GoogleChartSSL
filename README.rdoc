...
Now, instead of making your chart request to \http://chart.apis.google.com/chart, just send that request to /google_chart will be forwarded to google and returned over your server's connection.
